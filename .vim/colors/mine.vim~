...
hi MatchParen                   ctermfg=47   ctermbg=NONE  cterm=underline     guifg=#9fca56   guibg=NONE      gui=underline
...
hi Directory                    ctermfg=161   ctermbg=NONE  cterm=NONE          guifg=#cd3f45   guibg=NONE      gui=NONE
...
hi Boolean                      ctermfg=161   ctermbg=NONE  cterm=NONE          guifg=#cd3f45   guibg=NONE      gui=NONE
hi Character                    ctermfg=161   ctermbg=NONE  cterm=NONE          guifg=#cd3f45   guibg=NONE      gui=NONE
hi Comment                      ctermfg=59    ctermbg=NONE  cterm=NONE          guifg=#41535b   guibg=NONE      gui=NONE
hi Conditional                  ctermfg=227   ctermbg=NONE  cterm=NONE          guifg=#9fca56   guibg=NONE      gui=NONE
hi Constant                     ctermfg=161   ctermbg=NONE  cterm=NONE          guifg=#cd3f45   guibg=NONE      gui=NONE
hi Define                       ctermfg=47   ctermbg=NONE  cterm=NONE          guifg=#9fca56   guibg=NONE      gui=NONE
...
hi Float                        ctermfg=161   ctermbg=NONE  cterm=NONE          guifg=#cd3f45   guibg=NONE      gui=NONE
hi Function                     ctermfg=74    ctermbg=NONE  cterm=NONE          guifg=#55b5db   guibg=NONE      gui=NONE
hi Identifier                   ctermfg=227   ctermbg=NONE  cterm=NONE          guifg=#e6cd69   guibg=NONE      gui=NONE
hi Keyword                      ctermfg=47   ctermbg=NONE  cterm=NONE          guifg=#9fca56   guibg=NONE      gui=NONE
...
hi Number                       ctermfg=161   ctermbg=NONE  cterm=NONE          guifg=#cd3f45   guibg=NONE      gui=NONE
hi Operator                     ctermfg=47   ctermbg=NONE  cterm=NONE          guifg=#9fca56   guibg=NONE      gui=NONE
...
hi Statement                    ctermfg=47   ctermbg=NONE  cterm=NONE          guifg=#9fca56   guibg=NONE      gui=NONE
hi StorageClass                 ctermfg=227   ctermbg=NONE  cterm=NONE          guifg=#e6cd69   guibg=NONE      gui=NONE
...
hi javaScriptFunction           ctermfg=227   ctermbg=NONE  cterm=NONE          guifg=#e6cd69   guibg=NONE      gui=NONE
